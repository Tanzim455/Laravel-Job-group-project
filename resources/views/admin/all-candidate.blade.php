...
@section('title', 'All Candidate | ' . config('app.name'))
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">All Candidate</h5>
                </div>
            ...
            <div>
                @if (session()->has('success'))
                    <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-slate-700 dark:bg-slate-700 dark:text-green-400"
                        role="alert">
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-4 text-15">All Candidate</h6>
