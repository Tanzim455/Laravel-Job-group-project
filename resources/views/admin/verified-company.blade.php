    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Verified Companies</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-4 text-15">Verified Companies</h6>
                        ...
                        <div class="grid grid-cols-12 lg:grid-cols-12 gap-3">
                            ...
                            <div class="my-2 col-span-12 overflow-x-auto lg:col-span-12">
                                <table id="basic_tables"
                                    ...
                                    <tbody>
                                        @forelse ($verifiedCompanies as $company)
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    ...
                                                    @if (!$company->is_approved)
                                                        <form class="inline" method="POST"
                                                            action="{{ route('admin.approve.company', $company->id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <a href="{{ route('admin.approve.company', $company->id) }}"
                                                                onclick="event.preventDefault();
                                                                    this.closest('form').submit();">
                                                                <button type="button"
                                                                    class="focus:outline-none text-white bg-green-700 dark:bg-green-800 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Approve</button>
                                                            </a>
                                                        </form>
                                                    @endif
