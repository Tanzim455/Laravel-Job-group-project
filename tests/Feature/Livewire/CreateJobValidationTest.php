...
class CreateJobValidationTest extends TestCase
{
    /**
    ...
    public function test_all_required_fields_for_posting_a_job()
    {
        ...
        $response->assertHasErrors('title', 'description', 'min_experience',
            'max_experience', 'max_salary', 'min_salary', 'expiration_date',
            'category_id', 'company_id', 'qualification'
        );
        $response->assertHasNoErrors('url');
    }
